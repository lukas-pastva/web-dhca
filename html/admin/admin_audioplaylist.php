...
echo '  
  <div class="clanok_autor" style="text-align: left;">
    Sprava playlistu audio prehrávača.<br />Upload súborov a vkladanie do playlistu sú oddelené funkcie.<br />
    Vlož názov piesne, s diakritikou - taký ako sa zobrazí v sekcii AUDIO.<br />
    Vlož cestu k súboru v tvare mp3/nazov-suboru.mp3 (môžeš ho skopírovať pod tlačítkom "Zoznam/upload mp3" )<br />
    Vlož poradie súboru - piesne sa budú zoradzovať od najmenšieho po najväčšie číslo.<br />
    Zoznam a upload(nahrávanie) piesní nájdeš pod tlačítkom "Zoznam/Upload mp3".
  </div>
  <br />
  <br /><b>Vlož nový záznam</b>
   <div class="admin_msg_left">
    ...
    <form action="index.php?file=admin_audioplaylist.php&amp;x=3" method="post">
     <b>Názov piesne:</b><input type="text" name="href" size="130"><br /><br />
		...
		if ($i >= ($limit - PLAYLIST_POCET_NA_STRANU)){
           ...
           <div class="admin_msg_left">
            <form action="index.php?file=admin_audioplaylist.php&amp;x=1" method="post">
             <b>Názov piesne:</b><input type="text" name="href" size="130" value="'.$sprava['href'].'"><br /><br />
           ...
           <br />';
				...
				echo '
           <div class="admin_msg_left">
             <b>Názov piesne:</b>'.$sprava['href'].'<br />
